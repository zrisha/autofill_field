...
/**
 * Strings for component 'profilefield_autofill', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['privacy:metadata:profilefield_autofill:dataformat'] = 'The format of the stored user data.';
$string['privacy:metadata:profilefield_autofill:tableexplanation'] = 'Additional user information is stored here.';
