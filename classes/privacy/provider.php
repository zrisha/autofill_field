...
namespace profilefield_autofill\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        return $collection->add_database_table('user_info_data', [
            'userid' => 'privacy:metadata:profilefield_autofill:userid',
            'fieldid' => 'privacy:metadata:profilefield_autofill:fieldid',
            'data' => 'privacy:metadata:profilefield_autofill:data',
            'dataformat' => 'privacy:metadata:profilefield_autofill:dataformat'
        ], 'privacy:metadata:profilefield_autofill:tableexplanation');
    }
            ...
            if ($context->contextlevel == CONTEXT_USER && $context->instanceid == $user->id) {
                ...
                foreach ($results as $result) {
                    ...
                    \core_privacy\local\request\writer::with_context($context)->export_data([
                        get_string('pluginname', 'profilefield_autofill')], $data);
                }
            }
        }
    }
